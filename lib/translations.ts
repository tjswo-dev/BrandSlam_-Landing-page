...
export const translations = {
  ko: {
    ...
    hero: {
      ...
      desc: 'TikTok · Instagram · X(Twitter) 운영 중이라면 무료로 등록하세요. 제품 협찬 → 콘텐츠 제작 → 수익 창출까지 한 번에.',
    ...
    about: {
      ...
      creatorsPlat: 'Instagram · TikTok · X(Twitter)', creatorsRegion: '미국 · 일본 · 유럽 · 동남아',
    },
    success: {
  ...
  en: {
    ...
    hero: {
      ...
      desc: 'Running TikTok, Instagram, or X(Twitter)? Register for free and start receiving K-Beauty brand deals — product sponsorship, content support, and revenue all in one place.',
    ...
    about: {
      ...
      creatorsLabel: 'Global Creators',
      creatorsPlat: 'Instagram · TikTok · X(Twitter)', creatorsRegion: 'USA · Japan · Europe · SE Asia',
    },
    success: {
      label: 'Success Stories',
  ...
  ja: {
    ...
    hero: {
      ...
      desc: 'TikTok・Instagram・X(Twitter)で発信中なら無料で登録を。商品提供 → コンテンツ制作 → 収益化まで、まるごとサポート。',
    ...
    about: {
      ...
      creatorsPlat: 'Instagram · TikTok · X(Twitter)', creatorsRegion: '米国・日本・欧州・東南アジア',
    },
    success: {
      label: '成功事例',
